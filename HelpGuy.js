...
// In the new tab load the HTML from the Needs Help guy into an iFrame (needs to be cached at the server) (after convert from widgets to read only)

// Then start polling for updates from the Needs Help guy page (how often?)
// On receiving an update, make the appropriate changes on HelpGuyTab.html
